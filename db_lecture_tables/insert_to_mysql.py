...
(lecture_id, name, credit, code, semester, lecture_department)
VALUES (%s, %s, %s, %s, %s, %s)
"""
...
for lecture_id in major_df["교과목코드"].unique():
    ...
    cursor.execute("""
    INSERT IGNORE INTO GRADUO.major (lecture_id, is_required, start_year, end_year, is_industry)
    VALUES (%s, %s, %s, %s, %s)
...
for lecture_id in general_df["교과목코드"].unique():
    ...
    """, (lecture_id, is_field_required, None, start, end))
